<template>
    <v-app-bar class="px-6" style="background: linear-gradient(to right, #196344, #0f8252); color: #eee">
        <!--手機尺寸-->
        ...
        <v-menu min-width="200px" class="mr-4" rounded>
            <template v-slot:activator="{ props }">
                <v-btn icon v-bind="props">
                    <v-avatar color="#2E7D32" size="large">
                        <v-icon v-if="loginState === true">mdi-account-circle-outline</v-icon>
        ...
        <div class="ml-3">
            <v-btn id="menu-activator"><v-icon>mdi-earth</v-icon></v-btn>
        ...
        <div class="cartBox">
            ...
            <v-btn class="mx-2" icon="mdi-shopping-outline" @click="toggleCart"></v-btn>
        </div>
    </v-app-bar>
